        ...
        <div class="row">
            <div class="col-lg-9 offset-lg-3">
                <div class="sb-slick-slider" data-slick-setting='{
                    ...
                    <div class="single-slide bg-image bg-overlay--white" data-bg="<?php echo $imgSrc; ?>/image/bg-images/home-4-slider-1.jpg">
                    ...
                    <div class="single-slide bg-image bg-overlay--dark" data-bg="<?php echo $imgSrc; ?>/image/bg-images/home-4-slider-2.jpg">
    ...
    <div class="container">
        <div class="category-gallery-block">
            <a href="#" class="single-block hr-large">
                <img src="<?php echo $imgSrc; ?>/image/others/cat-gal-large.png" alt="">
            </a>
            <div class="single-block inner-block-wrapper">
                <a href="#" class="single-image mid-image">
                    <img src="<?php echo $imgSrc; ?>/image/others/cat-gal-mid.png" alt="">
                </a>
                <a href="#" class="single-image small-image">
                    <img src="<?php echo $imgSrc; ?>/image/others/cat-gal-small.png" alt="">
                </a>
                <a href="#" class="single-image small-image">
                    <img src="<?php echo $imgSrc; ?>/image/others/cat-gal-small-2.jpg" alt="">
                </a>
                <a href="#" class="single-image mid-image">
                    <img src="<?php echo $imgSrc; ?>/image/others/cat-gal-mid-2.png" alt="">
                </a>
            </div>
        </div>
    </div>
                    ...
                    <div class="single-block">
                        ...
                        <div class="product-slider product-list-slider multiple-row sb-slick-slider home-4-left-sidebar"
                            ...
                            <div class="single-slide">
                                <div class="product-card card-style-list">
                                    <div class="card-image">
                                        <img src="<?php echo $imgSrc; ?>/image/products/product-1.jpg" alt="">
                                    </div>
                            ...
                            <div class="single-slide">
                                <div class="product-card card-style-list">
                                    <div class="card-image">
                                        <img src="<?php echo $imgSrc; ?>/image/products/product-2.jpg" alt="">
                                    </div>
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            <a href="" class="author">
                            ...
                            <div class="single-slide">
                                <div class="product-card card-style-list">
                                    <div class="card-image">
                                        <img src="<?php echo $imgSrc; ?>/image/products/product-3.jpg" alt="">
                                    </div>
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            <a class="author">
                            ...
                            <div class="single-slide">
                                <div class="product-card card-style-list">
                                    <div class="card-image">
                                        <img src="<?php echo $imgSrc; ?>/image/products/product-4.jpg" alt="">
                                    </div>
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            <a href="#" class="author">
                            ...
                            <div class="single-slide">
                                <div class="product-card card-style-list">
                                    <div class="card-image">
                                        <img src="<?php echo $imgSrc; ?>/image/products/product-5.jpg" alt="">
                                    </div>
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            <a href="#" class="author">
                            ...
                            <div class="single-slide">
                                <div class="product-card card-style-list">
                                    <div class="card-image">
                                        <img src="<?php echo $imgSrc; ?>/image/products/product-6.jpg" alt="">
                                    </div>
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            <a href="" class="author">
                            ...
                            <div class="single-slide">
                                <div class="product-card card-style-list">
                                    <div class="card-image">
                                        <img src="<?php echo $imgSrc; ?>/image/products/product-7.jpg" alt="">
                                    </div>
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            <a href="" class="author">
                            ...
                            <div class="single-slide">
                                <div class="product-card card-style-list">
                                    <div class="card-image">
                                        <img src="<?php echo $imgSrc; ?>/image/products/product-8.jpg" alt="">
                                    </div>
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            <a href="" class="author">
                            ...
                            <div class="single-slide">
                                <div class="product-card card-style-list">
                                    <div class="card-image">
                                        <img src="<?php echo $imgSrc; ?>/image/products/product-9.jpg" alt="">
                                    </div>
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            <a href="" class="author">
                            ...
                            <div class="single-slide">
                                <div class="product-card card-style-list">
                                    <div class="card-image">
                                        <img src="<?php echo $imgSrc; ?>/image/products/product-10.jpg" alt="">
                                    </div>
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            <a href="" class="author">
