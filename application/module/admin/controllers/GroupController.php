    ...
    class GroupController extends Controller {
        ...
        public function __construct($arrParams){
            ...
            if(!isset($arrParams['page'])){
                ...
                Session::delete('filter_group_acp');
        ...
        public function indexAction(){
            $this->_viewObj->_titlePage = 'Group Manager - Bookstore';
            ...
            $this->_viewObj->render('group/index');
        }

        // Add và Edit
        public function formAction(){
            $this->_viewObj->_titlePage = 'Add Group - Bookstore';
            $task = 'add';

            // Nếu có tham số id trên url biết ngay là edit
            if(isset($this->_arrParams['id'])){
                $this->_viewObj->_titlePage = 'Edit Group - Bookstore';
                $task = 'edit';
            ...
            if(!empty($this->_arrParams['form'])){
                ...
                $validate->addRule('name', 'string', array('min' => 3, 'max' => 128))
                         ...
                         ->addRule('group_acp', 'status', array('accept' => array(0,1)))
                ...
                if($validate->isValidate() == true){
                    ...
                    if($task == 'add'){
                        Url::redirect('admin', 'group', 'form', null, 'admin/group/form');
                    }
                    else{
                        Url::redirect('admin', 'group', 'form', null, 'admin/group/form/id-'.$this->_arrParams['id']);
                    }
            ...
            $this->_viewObj->render('group/form');
        ...
        // Thay đổi status của group acp bằng ajax
        public function ajaxChangeGroupACPAction(){
            $result = $this->_modelObj->changeStatus($this->_arrParams, 'ajax-status-col-group-acp');
            echo json_encode($result);
        }
        ...
        public function trashAction(){
            ...
            Url::redirect('admin', 'group', 'index', null, 'admin/group');
        }
